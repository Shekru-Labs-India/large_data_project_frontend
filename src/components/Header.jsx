        ...
        <div className="menu-horizontal-wrapper">
          <ul className="menu-inner" style={{ marginLeft: 0 }}>
            ...
            <li className="menu-item active">
              <Link to="/userdashboard" className="menu-link ">
            ...
            <li className="menu-item">
              <Link to="/usersubscriptionlistview" className="menu-link ">
            ...
            {/* Apps */}
            <li className="menu-item">
              <Link to="/userhistory" className="menu-link ">
                <i className="menu-icon bx bxs-download" />
                <div data-i18n="Apps">File Download</div>
              </Link>
